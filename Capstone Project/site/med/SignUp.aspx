    ...
    <body>
        <form id="form1" runat="server">
                ...
                <div class="navbar navbar-default navbar-fixed-top" role="navigation">
                    <div class="container ">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="Default.aspx"><span><img src="icons/med_icon.png"
                                        alt="ABC Healthcare" height="30" /></span> ABC Healthcare</a>
            ...
            <div class="center-page">
                ...
                <div class="col-xs-11">
                    <asp:TextBox ID="txtUname" runat="server" Class="form-control" placeholder="Enter Your UserName">
                    </asp:TextBox>
                </div>
