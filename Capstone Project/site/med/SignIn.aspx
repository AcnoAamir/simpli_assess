                ...
                <div class="navbar navbar-default navbar-fixed-top" role="navigation">
                    <div class="container ">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="Default.aspx"><span><img src="icons/med_icon.png" alt="ABC Healthcare" height="30" /></span> ABC Healthcare</a>
            ...
            <div class="container ">
                <div class="form-horizontal ">
                    ...
                    <div class="form-group">
                        <asp:Label ID="Label1" CssClass="col-md-2 control-label " runat="server" Text="UserName">
                        </asp:Label>
                        <div class="col-md-3 ">
                    ...
                    <div class="form-group">
                        <asp:Label ID="Label2" CssClass="col-md-2 control-label " runat="server" Text="Password">
                        </asp:Label>
                        <div class="col-md-3 ">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 ">
                            ...
                            <asp:Label ID="Label3" CssClass=" control-label " runat="server" Text="Remember me">
                            </asp:Label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 ">
                            ...
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/SignUp.aspx">Sign Up
                            </asp:HyperLink>
                        </div>
                    </div>
                    ...
                    <%-- for forgot password--%>
                        <div class="form-group">
                            <div class="col-md-2 "> </div>
                            <div class="col-md-6 ">
                                <asp:HyperLink ID="HyForgotPass" runat="server" NavigateUrl="~/ForgotPassword.aspx">
