                    ...
                    <div class="container ">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="Default.aspx"><span>
                                    <img src="icons/icon1.png" alt="MyEShoppoing" height="30" /></span> Joe’s Pizza
                            </a>
                        </div>
                    ...
                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img src="ImgSlider/1.jpg" alt="Ad1" style="width: 100%;">
                                <div class="carousel-caption">
                                    <h3>
                                        Story in each size</h3>
                                    <p>
                                        Only at Joe’s Pizza</p>

                                </div>
                            </div>
                            <div class="item">
                                <img src="ImgSlider/2.jpg" alt="Ad2" style="width: 100%;">
                                <div class="carousel-caption">
                                    <h3>
                                        Special Offer for Diwali</h3>
                                    <p>
                                        Only at Joe’s Pizza</p>
                                </div>
                            </div>
                            <div class="item">
                                <img src="ImgSlider/3.jpg" alt="Ad3" style="width: 100%;">
                                <div class="carousel-caption">
                                    <h3>
                                    </h3>
                                    <p>
                            ...
                            <div class="item">
                                <img src="ImgSlider/6.jpg" alt="Ad4" style="width: 100%;">
                                <div class="carousel-caption">
                                    <h3>
                                        Quality is always guaranteed</h3>
                                    <p>
                                        Only at Joe’s Pizza</p>
                                </div>
                            </div>
                            <div class="item">
                                <img src="ImgSlider/5.jpg" alt="Ad5" style="width: 100%;">
                                <div class="carousel-caption">
                                    <h3>
                                        You always get what you want</h3>
                                    <p>
                                        Only at Joe’s Pizza</p>
                                </div>
                            </div>
